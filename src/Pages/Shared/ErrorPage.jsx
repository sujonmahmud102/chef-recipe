...
const ErrorPage = () => {
    ...
    return (
        <section className='md:flex items-center h-screen p-16 text-gray-900'>
            <div>
            ...
            <div className='container flex flex-col items-center justify-center px-5 mx-auto my-8'>
                ...
                <div className='max-w-md text-center'>
                    ...
                    <Link to='/' className='px-8 py-3 font-semibold rounded hover:bg-blue-400 bg-blue-800 text-white'>
                        Back to homepage
                    </Link>
                </div>
            </div>
